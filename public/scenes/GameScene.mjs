...
export class GameScene extends BaseScene {
    ...
    preload() {
        ...
        //map
        this.load.image('map', './assets/map/map_city_1.jpg');
    ...
    createOverlays() {
        ...
        this.firstKey = this.add.text(a.x, a.y, `${decrypt(a.text)}`, { font: "normal 32px MyCustomFont", fill: '#000000', align: 'center' }).setScrollFactor(0).setDepth(2);
        ...
        this.closeButton.on('pointerdown', () => {
            ...
            this.tweens.add({
                targets: [this.closeButton, this.overlayBackground, this.firstKey, this.emptyMan, this.emptyWoman, this.paper],
                alpha: 0,
                duration: 500,
                onComplete: () => {
                    try {
    ...
    showOverlay() {
        ...
        if (this.eventZone == LABEL_ID.FIRST_KEY) {
            ...
            if (this.fold.indexOf('firstKey') == -1) {
                this.mySocket.emitAddNewImg('firstKey');
            }
        }
    ...
    itemInteract(context) {
        ...
        if (context.isInZone) {
            ...
            if (!context.isOverlayVisible) {
                ...
                context.tweens.add({
                    targets: [context.overlayBackground, context.closeButton, context.firstKey, context.emptyMan, context.emptyWoman, context.paper],
                    alpha: 1,
                    duration: 500
                });
            }
