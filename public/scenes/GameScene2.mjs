...
export class GameScene2 extends BaseScene {
    ...
    createOverlays() {
        ...
        this.closeButton.on('pointerdown', () => {
            ...
            this.tweens.add({
                targets: [this.closeButton, this.overlayBackground, this.thirdKey, this.fourthKey, this.emptyKey, this.textA, this.textB],
                alpha: 0,
                duration: 500,
                onComplete: () => {
                    try {
    ...
    itemInteract(context) {
        ...
        if (context.isInZone) {
            ...
            if (!context.isOverlayVisible) {
                ...
                context.tweens.add({
                    targets: [context.overlayBackground, context.closeButton, context.thirdKey, context.fourthKey, context.emptyKey, context.textA, context.textB],
                    alpha: 1,
                    duration: 500
                });
            }
