...
export class GameScene6 extends BaseScene {
    ...
    createCollision() {
        ...
        this.matterCollision.addOnCollideStart({
            ...
            callback: function (eventData) {
                ...
                if (eventData.bodyB.label == LABEL_ID.DOOR_BACK_ID || eventData.bodyB.label == LABEL_ID.DOOR_LEFT_ID) {
    ...
    createOverlays() {
        ...
        this.fourthKey = this.add.text(a.x, a.y, `${decrypt(a.text)}`, { font: "normal 32px MyCustomFont", fill: '#000000', align: 'center' }).setScrollFactor(0).setDepth(2);
        ...
        this.closeButton.on('pointerdown', () => {
            ...
            this.tweens.add({
                targets: [this.closeButton, this.overlayBackground, this.fourthKey, this.emptyMan, this.emptyWoman, this.paper],
                alpha: 0,
                duration: 500,
                onComplete: () => {
                    try {
    ...
    showOverlay() {
        ...
        if (this.eventZone == LABEL_ID.FOURTH_KEY) {
            ...
            if (this.fold.indexOf('fourthKey') == -1) {
                this.mySocket.emitAddNewImg('fourthKey');
            }
        }
    ...
    itemInteract(context) {
        ...
        if (context.isInZone) {
            ...
            if (!context.isOverlayVisible) {
                ...
                context.tweens.add({
                    targets: [context.overlayBackground, context.closeButton, context.fourthKey, context.emptyMan, context.emptyWoman, context.paper],
                    alpha: 1,
                    duration: 500
                });
            }
